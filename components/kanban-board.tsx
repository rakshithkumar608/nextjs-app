...
import CreateJobApplicationDialouge from "./create-job-dialog";
...
function DroppableColumn({
    ...
    sortedColumns,
       ...
       return <Card className="min-w-[300px] shrink-0 shadow-md p-0">
        ...
        {sortedJobs.map((job, key) => (
          ...
          <CreateJobApplicationDialouge columnId={column._id} boardId={boardId} />
        </CardContent>
       </Card>
}
